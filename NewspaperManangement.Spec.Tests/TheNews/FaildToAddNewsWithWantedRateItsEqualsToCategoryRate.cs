...
{
    [Scenario("عدم ثبت شدن خبر به علت علت  برابر بودن وزن خبر با وزن دسته بندی")]
    [Story("",
  AsA = "مدیر روزنامه  ",
  IWantTo = "  میخواهم خبر به دسته بندی روزنامه اضافه کنم  ",
  InOrderTo = "  بتوانم خبرها را منتشر کنم.")]
    public class FaildToAddNewsWithWantedRateItsEqualsToCategoryRate : BusinessIntegrationTest
    {
        ...
        public FaildToAddNewsWithWantedRateItsEqualsToCategoryRate()
        {
        ...
        [When("من خبر با عنوان پرسپولیس در اسیا و محتوای پرسپولیس قهرمان اسیا شد و وزن 20 و تگ  فوتبال وفوتبال چمن از نویسنده با نام زهرااحمدی  را به دسته بندی ورزشی از روزنامه طلوع اضافه میکنم..")]
        private void  When()
        {
        ...
        [Then("باید خطای عدم ثبت شدن خبر به علت  برابر بودن وزن خبر با وزن دسته بندی مشاهده کنم.")]
